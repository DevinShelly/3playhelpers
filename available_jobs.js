...
toggle_autorefresh = function()
{
  ...
  if (!interval_id)
  {
    ...
    if ($("#autoclaim_delay")[0] && $("#autoclaim_delay")[0].value != "0")
    {
      duration = 5*60*1000;
    }
...
$("<style>")
    ...
    .appendTo("head");// Here You can type your custom JavaScript...e != "0"
